...
import { awardInterviewCoins } from './Coin.js';
...
export const getAvailableMentors = async (req, res) => {
  try {
    const { interviewType, expertise } = req.query;
    ...
    if (interviewType) {
      query['mentorProfile.interviewTypes'] = interviewType;
    }
    ...
    const mentors = await User.find(query)
      .select('name email givenName familyName picture mentorProfile mentorStatus')
